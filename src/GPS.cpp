...
void DriveToTargetXY(int x, int y, int base_speed, int GPS_DriveDistance_Threshold){
  ...
  AllLeft.spin(fwd, base_speed + DriveVelocity ,pct);
  AllRight.spin(fwd, base_speed - DriveVelocity ,pct);
...
void DriveToTargetXY_2(int x, int y, int base_speed, int GPS_DriveDistance_Threshold){
 //Initialize variables
  ...
  //Apply power to the motors
  AllRight.spin(fwd, DistanceTOSpeed + DriveVelocity ,pct);
  AllLeft.spin(fwd, DistanceTOSpeed - DriveVelocity ,pct);
